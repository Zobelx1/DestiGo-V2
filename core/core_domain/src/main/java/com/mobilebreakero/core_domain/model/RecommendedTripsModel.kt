...
data class RecommendedTripsModel(
    ...
    val trips: List<com.mobilebreakero.core_domain.model.TripsItem?>? = null
)
...
data class TripsItem(
    ...
    val placesToVisit: List<com.mobilebreakero.core_domain.model.PlacesToVisitItem?>? = null,
    ...
    val fullJourney: com.mobilebreakero.core_domain.model.FullJourney? = null,
    ...
    constructor() : this(
        ...
        tripId = "",
        category = "",
        fullJourney = com.mobilebreakero.core_domain.model.FullJourney(),
        reasonForTravel = ""
    )
}
